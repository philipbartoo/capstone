...
class EditProfileForm1(UserChangeForm):
    ...
    password=forms.CharField(widget=forms.HiddenInput,label='',required=False)
...
class PasswordChangingForm(PasswordChangeForm):
    ...
    new_password2=forms.CharField(label='New Password Verify',max_length=100, widget=forms.PasswordInput(attrs={'class':'form-control','type':'password'}))
